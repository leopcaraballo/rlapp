...
/// <summary>
/// Filtro de autorización que verifica rol de Cajero.
///
...
/// </summary>
public sealed class CashierOnlyFilter : IEndpointFilter
{
    private static readonly string[] AllowedRoles = ["Cashier", "Admin"];
        ...
        EndpointFilterDelegate next)
    {
        ...
        if (httpContext.User.Identity?.IsAuthenticated == true)
        {
            ...
            return Results.Json(
                new { Error = "Acceso denegado. Se requiere rol Cashier o Admin." },
